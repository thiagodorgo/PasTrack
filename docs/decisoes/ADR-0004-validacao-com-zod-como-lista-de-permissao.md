...
- Situação em 14/09/2026: o `validar()` e o formato de erro já estão na `main`. Os esquemas `strictObject` de cada rota entram nas próximas entregas, e os dois `it.fails` citados acima viram testes normais.

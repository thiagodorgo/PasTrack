...
- Situação em 15/09/2026: o `validar()` e o formato de erro estão na `main` desde o PR #9. Movimentações e alertas validam com `strictObject` desde o PR #18, e pastilhas, fabricantes e fornecedores desde o PR #19. Os dois `it.fails` citados acima viraram testes normais: a quantidade não numérica no PR #18 e o mass assignment no PR #19. A entrega de identidade (#PR-IDENTIDADE) valida as rotas de usuários do mesmo jeito, com `.strict()`.

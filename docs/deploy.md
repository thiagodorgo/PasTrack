...
| `BCRYPT_CUSTO`                | não                | `12`                    | Custo do hash das senhas. Precisa estar entre 12 e 15.                                                                                                                                         |
...
| `RATE_LIMIT_LOGIN_MAX`        | não                | `5`                     | Tentativas de login erradas, por IP e e-mail, antes do bloqueio temporário.                                                                                                                    |
| `RATE_LIMIT_LOGIN_JANELA_MIN` | não                | `15`                    | Janela, em minutos, da contagem de tentativas de login.                                                                                                                                        |
| `RATE_LIMIT_GLOBAL_MAX`       | não                | `1000`                  | Requisições por minuto de um mesmo IP antes do login. Serve só contra varredura.                                                                                                               |
| `RATE_LIMIT_USUARIO_MAX`      | não                | `300`                   | Requisições por minuto de cada usuário logado, em qualquer posto.                                                                                                                              |

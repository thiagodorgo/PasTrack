...
| RF-04 cadastrar usuário com senha temporária | `integration/usuarios.spec.ts`                                                            | `pages/Usuarios.spec.tsx`, `services/usuarios.spec.ts`                      | instalação nova                |
| RF-05 alterar nome e perfil                  | `integration/usuarios.spec.ts`                                                            | `pages/Usuarios.spec.tsx`, `services/usuarios.spec.ts`                      | —                              |
| RF-06 ativar e desativar                     | `integration/usuarios.spec.ts`, `security/usuario-inativo.spec.ts`                        | `pages/Usuarios.spec.tsx`, `services/usuarios.spec.ts`                      | —                              |
| RF-07 redefinir a senha de outro             | `integration/usuarios.spec.ts`                                                            | `pages/Usuarios.spec.tsx`, `services/usuarios.spec.ts`                      | —                              |
| RF-08 recuperar o administrador              | `integration/redefinir-senha-admin.spec.ts`                                               | —                                                                           | —                              |
| RF-09 fabricante                             | `integration/fabricantes.spec.ts`                                                         | `pages/Fabricantes.spec.tsx`, `services/cadastros.spec.ts`                  | —                              |
| RF-10 fornecedor com CNPJ                    | `integration/fornecedores.spec.ts`, `unit/cnpj.spec.ts`                                   | `pages/Fornecedores.spec.tsx`, `utils/formato.spec.ts`                      | —                              |
...
| RN-04 estoque mínimo zero não gera alerta | `integration/alertas.spec.ts`, `integration/painel.spec.ts`; na tela, `pages/Pastilhas.spec.tsx`         |
